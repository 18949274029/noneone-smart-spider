 ...
 * 
 * @author yuyang001 2017年4月6日 下午3:13:12
 */
public class Http4ClientUtil {
    ...
    public static String axPostJson(String url, String params,String userName,String passWord) throws IOException {
